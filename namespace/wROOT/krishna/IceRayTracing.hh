...
namespace IceRayTracing{
  ...
  TGraph* GetFullReflectedRayPath(double z0, double x1, double z1,double lvalueR, double zlim);
  ...
  TGraph* GetFullRefractedRayPath(double z0, double x1, double z1, double zmax, double lvalueRa, double zlim);
