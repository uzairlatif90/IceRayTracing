...
double* GetDirectRayPar_Cnz(double z0, double x1, double z1, double A_ice_Cnz){
  ...
  double timeD=(sqrt( pow(x1,2) + pow(z1-z0,2) )/c_light_ms)*A_ice_Cnz;
...
double *GetReflectedRayPar_Cnz(double z0, double x1 , double z1, double A_ice_Cnz){
  ...
  double timeR1=(sqrt( pow(x2,2) + pow(z2-z0,2) )/c_light_ms)*A_ice_Cnz;
  double timeR2=(sqrt( pow(x2-x1,2) + pow(z2-z1,2) )/c_light_ms)*A_ice_Cnz;
  double timeR= timeR1 + timeR2;
